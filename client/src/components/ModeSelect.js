      ...
      <div className="inner-container is-center">
            ...
            <div>
              <div className="mode-select_vs">
                  <div className="avatar is-md" style={avatarBG}></div>
                  <span>vs.</span>
              ...
              <div>
                <div className="mode-select_vs">
                    <div className="avatar is-md" style={avatarBG}></div>
                    <span>vs.</span>
                    <div className="avatar is-md" style={{backgroundImage: `url('http://emojipedia-us.s3.amazonaws.com/cache/4b/93/4b932980a0fe8f7ad711a8c2fcc68ce4.png')`}}></div>
                </div>
